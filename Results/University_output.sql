...
-- URL: jdbc:sqlite:TargetDatabases\University.db
-- User Name: null
-- Supported Type: BLOB
...
CREATE INDEX department_1 ON department (d_id DESC);
CREATE INDEX staff_1 ON staff (s_id DESC);
CREATE INDEX courses_1 ON courses (c_id DESC);
CREATE INDEX projects_1 ON projects (p_id DESC);
CREATE INDEX give_course_1 ON give_course (s_id DESC);
CREATE INDEX give_course_1_c_id ON give_course (c_id DESC);
CREATE INDEX work_on_1 ON work_on (s_id DESC);
CREATE INDEX work_on_1_p_id ON work_on (p_id DESC);
