...
-- URL: jdbc:sqlite:TargetDatabases\LSH.db
-- User Name: null
-- Supported Type: BLOB
...
CREATE INDEX planets_1 ON planets (name DESC);
CREATE INDEX powers_1 ON powers (hero_id DESC);
CREATE INDEX powers_1_description ON powers (description DESC);
CREATE INDEX missions_1 ON missions (name DESC);
